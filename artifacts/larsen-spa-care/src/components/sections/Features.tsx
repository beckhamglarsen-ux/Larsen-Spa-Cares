      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <h3 className="text-2xl md:text-3xl font-bold font-display mb-4 relative z-10">Local to St. George &amp; Washington County</h3>
            <p className="text-white/80 text-lg mb-6 relative z-10 leading-relaxed">
              We are a local business serving Desert Color, Red Rock, Black Desert, and the greater St. George area. We understand the local water hardness, extreme temperatures, and high-use rental environments.
            </p>
